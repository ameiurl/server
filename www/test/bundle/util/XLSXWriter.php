...
class XLSXWriter
{
	...
	public function writeSheetRow($sheet_name, array $row, $row_options=null)
	{
		...
		if (!empty($row_options))
		{
            ...
            //替换原来的头部的format
            $header_types = $row_options['format'];
	...
	protected function styleFontIndexes()
	{
		...
		static $border_style_allowed = array('thin','medium','thick','dashDot','dashDotDot','dashed','dotted','double','hair','mediumDashDot','mediumDashDotDot','mediumDashed','slantDashDot','solid');
